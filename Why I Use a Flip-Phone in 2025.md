...
If you are interested in learning more about the technical aspects of using a dumbphone, as well as this specific phone, I have a seperate post titiled [*So you want to use a dumbphone? (TBD)*](https://github.com/user-attachments/assets/729d3388-48b0-4571-ae8b-44ac361a60c4). It's also important to note that you don't need to buy anything in order to create good habits with technology, you can do this right now. More on this later.
